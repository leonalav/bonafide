...
This design system uses **Manrope** for technical labels, headlines, and code. Its geometric, slightly tech-leaning aesthetic provides the "unconventional" feel required for an IDE. **Inter** is utilized for body copy and documentation to ensure maximum readability and a grounded, professional feel.

The code editor should utilize Manrope with a slightly increased line-height (1.6x) to facilitate scanning. All UI labels should use the `label-caps` style to differentiate them from the code content they surround.
