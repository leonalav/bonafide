...
const PATHS: Record<string, string> = {
  ...
  "flask-conical":
    "M10 2v7.5L4.2 18.4A2 2 0 0 0 5.9 21.5h12.2a2 2 0 0 0 1.7-3.1L14 9.5V2 M8.5 2h7 M7 15h10",
  "line-chart": "M3 3v18h18 M7 15l4-4 3 3 5-6",
  package: "M12 2 3 7v10l9 5 9-5V7L12 2 M3 7l9 5 9-5 M12 12v10",
  "git-branch":
    "M6 3v12 M18 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6 M6 21a3 3 0 1 0 0-6 3 3 0 0 0 0 6 M18 9a9 9 0 0 1-9 9",
  ...
  "folder-open":
    "M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M3 15l2-2h4l2 2h8a2 2 0 0 0 2-2v-3",
  "file-plus":
    "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z M14 2v6h6 M12 12v6 M9 15h6",
  "folder-plus":
  ...
  python:
    "M12 3c-3 0-3 2-3 2v2h6v1H6s-3 0-3 4 3 4 3 4h2v-2s0-3 3-3h4s3 0 3-3V5s0-2-4-2z M9 5.5h.01 M15 18.5h.01",
  file: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z M14 2v6h6",
  "file-code":
    "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z M14 2v6h6 M9 13l-2 2 2 2 M14 13l2 2-2 2",
  ...
  keyboard:
    "M4 6h16a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1 M7 10h.01 M11 10h.01 M15 10h.01 M8 14h8",
  palette:
    "M12 2a10 10 0 1 0 0 20 2 2 0 0 0 2-2 2 2 0 0 0-.5-1.3 2 2 0 0 1 1.3-3.4H17a5 5 0 0 0 5-5c0-4.9-4.5-8.7-10-8.7 M7.5 12a1 1 0 1 0 0-2 1 1 0 0 0 0 2 M12 8a1 1 0 1 0 0-2 1 1 0 0 0 0 2 M16.5 12a1 1 0 1 0 0-2 1 1 0 0 0 0 2",
  ...
  "external-link":
    "M15 3h6v6 M10 14 21 3 M21 14v5a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5",
  box: "M12 2 3 7v10l9 5 9-5V7L12 2 M3 7l9 5 9-5 M12 12v10",
  database:
    "M12 3c4.4 0 8 1.3 8 3s-3.6 3-8 3-8-1.3-8-3 3.6-3 8-3 M4 6v12c0 1.7 3.6 3 8 3s8-1.3 8-3V6 M4 12c0 1.7 3.6 3 8 3s8-1.3 8-3",
  image:
    "M3 5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z M8.5 10a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3 M21 16l-5-5L5 21",
  ...
  network:
    "M8 2v4 M12 2v4 M16 2v4 M4 10h4 M16 10h4 M8 14h8v6H8z M4 20h4 M16 20h4",
  bug: "M8 2l1.8 3.5L10 7l-.2 2.5L8 12v2l2 1.5V17l-2 1.5V21 M16 2l-1.8 3.5L14 7l.2 2.5L16 12v2l-2 1.5V17l2 1.5V21 M9 21h6 M6 12h12",
  ...
  scissors:
    "M6 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6 M6 21a3 3 0 1 0 0-6 3 3 0 0 0 0 6 M20 4 8.12 15.88 M14.47 14.48 20 20 M8.12 8.12 12 12",
  "message-square":
  ...
  replace:
    "M14 4h6v6 M16 14l-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2 M14 20h6v-6",
  "search-code": "M11 4a7 7 0 1 0 4.95 11.95 M21 21l-4.3-4.3 M9 10l2 2 4-4",
  // Find/Replace widget icons (VS Code parity, kept as inline SVG geometry).
  // Each path is a Lucide-style outline: strokes are rendered by the
  // shared <Icon> wrapper at strokeWidth 1.75 (or 2 when active).
  // `case-sensitive` is the "Aa" mark (a small "a" inside an "A"),
  // `whole-word` is "ab" with the "b" inside a rounded box,
  // `regex` is the standard ".*" pattern, `replace-all` is two stacked
  ...
  "replace-all":
    "M14 4h6v6 M16 14l-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2 M14 20h6v-6 M21 16l-2-2H10a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2",
